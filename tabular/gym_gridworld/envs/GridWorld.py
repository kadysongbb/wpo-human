...
class GridWorld(gym.Env):
    ...
    def __init__(self, file_name = "yellow_room2.txt", fail_rate = 0.0, terminal_reward = 100.0, move_reward = -1, bump_reward = -1, bomb_reward = -10):
